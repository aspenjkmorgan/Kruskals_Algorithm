...
# Make a union-find structure for a graph with 5 nodes.
...
# The second entry in each array is a count of the number of nodes that point to 
# that node.  This is not necessary to have in your implementation, but I found it 
# to be a useful way to track this information in mine.  
